...
public class DictionaryOfLists3Tests
{
    [Fact]
    private void CopyConstructor_Copies()
    {
        ...
        // Act
        var listDict2 = new DictionaryOfLists3<int, string>(listDict);
    ...
    [Fact]
    private void ListProxy_Add_Adds()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_AddToEmpty_AddsToDict()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_Insert_Inserts()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_Remove_Removes()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_Remove_ThenEmpty_RemovesFromDict()
    {
        // Arrange
    ...
    [Fact]
    private void ListProxy_RemoveAt_Removes()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_RemoveAt_ThenEmpty_RemovesFromDict()
    {
        // Arrange
        var listPre = new List<string> { "A" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_Clear_Clears()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_Indexer_Stores()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_ClearAndAdd_HasValue()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_ClearAndAdd_ListCorrect()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
    ...
    [Fact]
    private void ListProxy_ClearAndAddBothInDictAndListRef_ListCorrect()
    {
        // Arrange
        var listPre = new List<string> { "A", "B", "C" };
        var listDict = new DictionaryOfLists3<int, string>();
